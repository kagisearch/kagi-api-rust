...
pub struct Translate200ResponseOneOfDefinitionDefinitionsInner {
    /// Part of speech
    #[serde(rename = "partOfSpeech", skip_serializing_if = "Option::is_none")]
    pub part_of_speech: Option<String>,
    #[serde(rename = "meanings", skip_serializing_if = "Option::is_none")]
    pub meanings: Option<Vec<models::Translate200ResponseOneOfDefinitionDefinitionsInnerMeaningsInner>>,
}

impl Translate200ResponseOneOfDefinitionDefinitionsInner {
    pub fn new() -> Translate200ResponseOneOfDefinitionDefinitionsInner {
