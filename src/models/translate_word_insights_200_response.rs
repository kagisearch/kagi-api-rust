...
pub struct TranslateWordInsights200Response {
    /// The translated text with markers (<<INSIGHT_N>>) indicating insight locations
    #[serde(rename = "marked_translation", skip_serializing_if = "Option::is_none")]
    pub marked_translation: Option<String>,
    #[serde(rename = "insights", skip_serializing_if = "Option::is_none")]
    pub insights: Option<Vec<models::TranslateWordInsights200ResponseInsightsInner>>,
}

impl TranslateWordInsights200Response {
    pub fn new() -> TranslateWordInsights200Response {
        TranslateWordInsights200Response {
            marked_translation: None,
            insights: None,
        }
    }
}
