...
pub struct TranslateRomanize200Response {
    /// Romanized text
    #[serde(rename = "romanization", skip_serializing_if = "Option::is_none")]
    pub romanization: Option<String>,
}

impl TranslateRomanize200Response {
    pub fn new() -> TranslateRomanize200Response {
