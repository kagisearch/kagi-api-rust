...
pub struct TranslateDictionary200Response {
    #[serde(rename = "definition", skip_serializing_if = "Option::is_none")]
    pub definition: Option<Box<models::TranslateDictionary200ResponseDefinition>>,
    #[serde(rename = "language", skip_serializing_if = "Option::is_none")]
    pub language: Option<Box<models::TranslateDictionary200ResponseLanguage>>,
}

impl TranslateDictionary200Response {
    pub fn new() -> TranslateDictionary200Response {
