...
pub struct Translate200ResponseOneOfDefinition {
    ...
    pub definitions: Option<Vec<models::Translate200ResponseOneOfDefinitionDefinitionsInner>>,
}

impl Translate200ResponseOneOfDefinition {
    /// Dictionary definition of the translated term (if available)
    pub fn new() -> Translate200ResponseOneOfDefinition {
