...
#[serde(untagged)]
pub enum Translate200Response {
    Translate200ResponseOneOf(Box<models::Translate200ResponseOneOf>),
    Translate200ResponseOneOf1(Box<models::Translate200ResponseOneOf1>),
}

impl Default for Translate200Response {
    fn default() -> Self {
        Self::Translate200ResponseOneOf(Default::default())
    }
}
