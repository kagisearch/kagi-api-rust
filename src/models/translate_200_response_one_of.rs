...
pub struct Translate200ResponseOneOf {
    /// Translated text
    ...
    pub detected_language: Option<Box<models::Translate200ResponseOneOfDetectedLanguage>>,
    #[serde(rename = "definition", skip_serializing_if = "Option::is_none")]
    pub definition: Option<Box<models::Translate200ResponseOneOfDefinition>>,
}

impl Translate200ResponseOneOf {
    pub fn new() -> Translate200ResponseOneOf {
