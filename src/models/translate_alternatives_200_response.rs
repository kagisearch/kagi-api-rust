...
pub struct TranslateAlternatives200Response {
    ...
    pub elements: Option<Vec<models::TranslateAlternatives200ResponseElementsInner>>,
}

impl TranslateAlternatives200Response {
    pub fn new() -> TranslateAlternatives200Response {
