...
pub struct TranslateWordInsights200ResponseInsightsInner {
    ...
    pub variations: Option<Vec<models::TranslateWordInsights200ResponseInsightsInnerVariationsInner>>,
    /// Category of the insight in the explanation language
    #[serde(rename = "type", skip_serializing_if = "Option::is_none")]
    pub r#type: Option<String>,
}

impl TranslateWordInsights200ResponseInsightsInner {
    pub fn new() -> TranslateWordInsights200ResponseInsightsInner {
